...
public class Main {
  ...
  public static void main (String[] args) {
    ...
    System.out.print(String.format("%s $ ", fimilarPath));
    while (true) {
      ...
      if (checkTheCommand("ls", question)) {
        ...
        try{
          if (Files.exists(Paths.get(currentPath+"/"+commandContent[1]))) {
            ...
            System.out.println(String.format("cat: %s: No such file or directory", commandContent[1]));
          }
        } catch (Throwable err) {
...
//            System.out.println(Arrays.toString(commandPath));
        ...
        System.out.printf(String.format("jsh: command no found: %s\n", question));
      }
      System.out.print(String.format("%s $ ", currentPath));
    }
  }
}
